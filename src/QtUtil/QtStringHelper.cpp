...
// Les positions des caractères grecs dans la table de caractères ISO 8859 (partie 7). Les majuscules et minuscules sont contigues.
static	const	unsigned int	alphaMajPos	= 913;
static	const	unsigned int	alphaMinPos	= alphaMajPos + 32;

static const QChar 	alphaMinArray [1]		= { QChar (alphaMinPos) };
static const QChar 	alphaMajArray [1]		= { QChar (alphaMajPos) };
static const QChar 	betaMinArray [1]		= { QChar (alphaMinPos + 1) };
static const QChar 	betaMajArray [1]		= { QChar (alphaMajPos + 1) };
static const QChar 	gammaMinArray [1]		= { QChar (alphaMinPos + 2) };
static const QChar 	gammaMajArray [1]		= { QChar (alphaMajPos + 2) };
static const QChar 	deltaMinArray [1]		= { QChar (alphaMinPos + 3) };
static const QChar 	deltaMajArray [1]		= { QChar (alphaMajPos + 3) };
static const QChar 	epsilonMinArray [1]		= { QChar (alphaMinPos + 4) };
static const QChar 	epsilonMajArray [1]		= { QChar (alphaMajPos + 4) };
static const QChar 	dzetaMinArray [1]		= { QChar (alphaMinPos + 5) };
static const QChar 	dzetaMajArray [1]		= { QChar (alphaMajPos + 5) };
static const QChar 	etaMinArray [1]			= { QChar (alphaMinPos + 6) };
static const QChar 	etaMajArray [1]			= { QChar (alphaMajPos + 6) };
static const QChar 	thetaMinArray [1]		= { QChar (alphaMinPos + 7) };
static const QChar 	thetaMajArray [1]		= { QChar (alphaMajPos + 7) };
static const QChar 	iotaMinArray [1]		= { QChar (alphaMinPos + 8) };
static const QChar 	iotaMajArray [1]		= { QChar (alphaMajPos + 8) };
static const QChar 	kappaMinArray [1]		= { QChar (alphaMinPos + 9) };
static const QChar 	kappaMajArray [1]		= { QChar (alphaMajPos + 9) };
static const QChar 	lambdaMinArray [1]		= { QChar (alphaMinPos + 10) };
static const QChar 	lambdaMajArray [1]		= { QChar (alphaMajPos + 10) };
static const QChar 	muMinArray [1]			= { QChar (alphaMinPos + 11) };
static const QChar 	muMajArray [1]			= { QChar (alphaMajPos + 11) };
static const QChar 	nuMinArray [1]			= { QChar (alphaMinPos + 12) };
static const QChar 	nuMajArray [1]			= { QChar (alphaMajPos + 12) };
static const QChar 	xsiMinArray [1]			= { QChar (alphaMinPos + 13) };
static const QChar 	xsiMajArray [1]			= { QChar (alphaMajPos + 13) };
static const QChar 	omicronnMinArray [1]	= { QChar (alphaMinPos + 14) };
static const QChar 	omicronnMajArray [1]	= { QChar (alphaMajPos + 14) };
static const QChar 	piMinArray [1]			= { QChar (alphaMinPos + 15) };
static const QChar 	piMajArray [1]			= { QChar (alphaMajPos + 15) };
static const QChar 	roMinArray [1]			= { QChar (alphaMinPos + 16) };
static const QChar 	roMajArray [1]			= { QChar (alphaMajPos + 16) };
static const QChar 	sigmaMinArray [1]		= { QChar (alphaMinPos + 18) };
static const QChar 	sigmaMajArray [1]		= { QChar (alphaMajPos + 18) };
static const QChar 	tauMinArray [1]			= { QChar (alphaMinPos + 19) };
static const QChar 	tauMajArray [1]			= { QChar (alphaMajPos + 19) };
static const QChar 	upsilonMinArray [1]		= { QChar (alphaMinPos + 20) };
static const QChar 	upsilonMajArray [1]		= { QChar (alphaMajPos + 20) };
static const QChar 	phiMinArray [1]			= { QChar (alphaMinPos + 21) };
static const QChar 	phiMajArray [1]			= { QChar (alphaMajPos + 21) };
static const QChar 	khiMinArray [1]			= { QChar (alphaMinPos + 22) };
static const QChar 	khiMajArray [1]			= { QChar (alphaMajPos + 22) };
static const QChar 	psiMinArray [1]			= { QChar (alphaMinPos + 23) };
static const QChar 	psiMajArray [1]			= { QChar (alphaMajPos + 23) };
static const QChar 	omegaMinArray [1]		= { QChar (alphaMinPos + 24) };
static const QChar 	omegaMajArray [1]		= { QChar (alphaMajPos + 24) };
